...
#pragma omp parallel shared(a, b, nthreads, locka, lockb) private(tid)
  ...
  #pragma omp sections nowait
	...
	/* Noah Comments:
	   ...
	   In the old code, the locks were not unset properly, which
	   caused the program to lock. The only required adjustment.
...
*/
      ...
      // Make sure to get lockb before releasing locka
      omp_set_lock(&lockb); 
